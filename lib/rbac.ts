...
export const routeRoleMap: Array<{ prefix: string; roles: UserRole[] }> = [
  ...
  { prefix: "/services", roles: ["admin", "operator", "supervisor"] },
  ...
  { prefix: "/piano-giorno", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/controllo-giornata", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/emergenza-assistenza", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/bus-tours", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/liste-bruno", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/smistamento-continente", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/bus-network", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/bus-convocations", roles: ["admin", "operator", "supervisor"] },
  ...
  { prefix: "/driver-file-import", roles: ["admin", "operator", "supervisor"] },
  ...
  { prefix: "/fleet-ops", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/scan", roles: ["admin", "operator", "supervisor", "assistenza"] },
  { prefix: "/mappa-live", roles: ["admin", "operator", "supervisor"] },
  { prefix: "/mario-assistant", roles: ["admin", "operator", "supervisor"] },
  ...
  { prefix: "/whatsapp-log",      roles: ["admin", "operator", "supervisor", "assistenza"] },
  { prefix: "/whatsapp", roles: ["admin", "operator", "supervisor", "assistenza"] },
...
export const capabilityRoleMap: Record<AppCapability, UserRole[]> = {
  ...
  "fleet_ops:view": ["admin", "operator", "supervisor"],
...
export const routeCapabilityMap: Array<{ prefix: string; capability: AppCapability }> = [
  ...
  { prefix: "/navette-hotel", capability: "planning:manage" },
  ...
  { prefix: "/driver-file-import", capability: "excel_import:view" },
...
export function hasCapability(role: UserRole | null, capability: AppCapability, overrides?: CapabilityOverrides): boolean {
  if (!role) return false;
  // Admin e supervisor vedono tutto — gli override non li toccano
