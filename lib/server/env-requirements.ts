...
export const ENV_REQUIREMENTS: EnvRequirement[] = [
  ...
  { key: "WHATSAPP_ACCESS_TOKEN", requiredForBeta: false, category: "whatsapp", notes: "Preferred permanent Meta System User token for WhatsApp reminders and templates." },
  { key: "WHATSAPP_TOKEN", requiredForBeta: false, category: "whatsapp", notes: "Legacy fallback for WhatsApp reminders; prefer WHATSAPP_ACCESS_TOKEN." },
