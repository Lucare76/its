...
if (isDev) {
  ...
  if (!globalScope[marker]) {
    ...
    console.info("[env] presence", {
      ...
      GOOGLE_CLOUD_VISION_CLIENT_EMAIL: Boolean(process.env.GOOGLE_CLOUD_VISION_CLIENT_EMAIL),
      GOOGLE_CLOUD_VISION_PRIVATE_KEY: Boolean(process.env.GOOGLE_CLOUD_VISION_PRIVATE_KEY),
      GOOGLE_CLOUD_VISION_INPUT_BUCKET: Boolean(process.env.GOOGLE_CLOUD_VISION_INPUT_BUCKET),
      GOOGLE_CLOUD_VISION_OUTPUT_BUCKET: Boolean(process.env.GOOGLE_CLOUD_VISION_OUTPUT_BUCKET),
