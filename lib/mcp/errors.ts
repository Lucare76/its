export type McpErrorCode =
  ...
  | "MCP_CONFIRMATION_ALREADY_USED"
  | "MCP_CONFIRMATION_STALE"
  | "MCP_ASSIGNMENT_CONFLICT"
  | "MCP_STATUS_TRANSITION_INVALID";
...
const STATUS_BY_CODE: Record<McpErrorCode, number> = {
  ...
  MCP_CONFIRMATION_REQUIRED: 400,
  MCP_CONFIRMATION_INVALID: 400,
  MCP_CONFIRMATION_EXPIRED: 409,
  MCP_CONFIRMATION_ALREADY_USED: 409,
  MCP_CONFIRMATION_STALE: 409,
  MCP_ASSIGNMENT_CONFLICT: 409,
  MCP_STATUS_TRANSITION_INVALID: 409,
};
