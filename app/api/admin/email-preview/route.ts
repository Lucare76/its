...
const SAMPLES: Record<string, () => string> = {
  ...
  report: () => buildServiceListEmailHtml({
    ...
    lines: [
      { date: "2026-06-15", time: "09:00", direction: "arrival",   customer_name: "Famiglia Bianchi", pax: 3, hotel_or_destination: "Hotel Moresco" },
      { date: "2026-06-15", time: "11:30", direction: "arrival",   customer_name: "Coppia Verdi",     pax: 2, hotel_or_destination: "Hotel Regina Isabella" },
      { date: "2026-06-15", time: "14:00", direction: "departure", customer_name: "Rossi Group",      pax: 6, hotel_or_destination: "Porto Ischia" },
      { date: "2026-06-16", time: "08:45", direction: "arrival",   customer_name: "Tour Esposito",    pax: 4, hotel_or_destination: "Hotel San Montano" },
    ],
  }),
