      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[92vh] flex flex-col">
        ...
        <div className="flex-1 overflow-hidden p-4">
          {loading
            ...
            : html
              ? <iframe srcDoc={html} className="w-full h-full rounded-xl border border-slate-100" sandbox="allow-same-origin allow-scripts" title="Anteprima voucher" />
