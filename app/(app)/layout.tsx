  ...
  return (
    <>
      ...
      <div className="min-w-0 space-y-4">
        {pathname !== "/services/new" && pathname !== "/inbox" && pathname !== "/dashboard" && pathname !== "/arrivals" && pathname !== "/departures" && pathname !== "/mappa-live" ? <header className="relative z-30 overflow-hidden rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm md:px-5">
