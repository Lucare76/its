                    ...
                    if (isEditing) {
                      return (
                        <Fragment key={hotel.id}>
                          <tr key={`${hotel.id}-summary`} className="border-t border-slate-100 bg-slate-50/70 align-top">
                            ...
                            <td className="px-3 py-3 text-sm text-slate-500">
                              {hotel.small_vehicle_only ? "Solo bus piccolo" : "Accesso standard"}
                            </td>
                            <td className="px-3 py-3 text-xs text-slate-500">
                              {[hotel.email, hotel.phone, hotel.contact_name].filter(Boolean).join(" · ") || "Nessun contatto"}
                            </td>
                            <td className="px-3 py-3 text-xs text-slate-500">
                              {(aliasByHotel.get(hotel.id) ?? []).slice(0, 2).map((alias) => alias.alias).join(", ") || "—"}
                            </td>
                            ...
                            <td className="px-3 py-3">
                              <div className="flex flex-wrap gap-2">
                                <button
                                  ...
                                  className="rounded-md border border-slate-900 bg-slate-900 px-3 py-1.5 text-xs font-semibold text-white disabled:opacity-50"
                                >
                                  {saving ? "Salvo..." : "Salva"}
                                </button>
                                <button
                                  ...
                                  className="rounded-md border border-slate-300 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:bg-white"
                                >
                                  Annulla
                                </button>
                              </div>
                          ...
                          <tr key={`${hotel.id}-editor`} className="border-t border-slate-100 bg-white">
