...
// operativa non trova mai righe da bloccare (nessuna riga "matched" -> mai
// SHUTTLE_HAS_OPERATIONAL_SERVICES), cosi' i test originali su range/date
// restano invariati: contano solo se la RPC e' stata invocata (delete=1) e
// se ha ricevuto righe da inserire (insert=1 quando p_new_rows non e' vuoto).
