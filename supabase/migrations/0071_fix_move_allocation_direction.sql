-- Fix: il check di capienza bus destinazione contava pax da TUTTE le direzioni
-- della stessa data (andata + ritorno insieme), causando "Capienza superata" erronea.
-- Aggiunge il filtro s.direction = v_service.direction.
...
begin
  ...
  -- Conta pax del bus destinazione per la stessa data E stessa direzione
