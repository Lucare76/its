-- Fix: ripristina coalesce per customer_name nella view ops_bus_allocation_details
-- Migration 0053 aveva semplificato a s.customer_name perdendo il fallback su first_name+last_name
