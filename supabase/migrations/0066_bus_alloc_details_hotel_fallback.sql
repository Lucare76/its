-- Aggiorna ops_bus_allocation_details per usare meeting_point come fallback hotel
-- (i servizi importati via Excel non hanno hotel_id, ma hanno meeting_point = nome hotel)
...
select
  ...
  s.hotel_id,
  coalesce(h.name, s.meeting_point) as hotel_name,
